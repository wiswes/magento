...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/wiswes/magento/releases)
...
```bash
unzip ~/Downloads/wiswes-magento-1.0.0.zip -d .
mkdir -p app/code/WisWes && mv wiswes-magento-1.0.0 app/code/WisWes/MCP
