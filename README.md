...
[![Version](https://img.shields.io/badge/version-1.0.1-blue.svg)](https://github.com/wiswes/magento/releases)
...
cd app/code/WisWes/MCP && git checkout v1.0.1 && cd -
...
```bash
unzip ~/Downloads/wiswes-magento-1.0.1.zip -d .
mkdir -p app/code/WisWes && mv wiswes-magento-1.0.1 app/code/WisWes/MCP
