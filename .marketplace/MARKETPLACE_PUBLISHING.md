...
> ✅ Phase 4 — `v1.0.4` tagged + pushed; Packagist serves it as
>    `wiswes/magento-mcp:1.0.4` within ~60 seconds of the push.
...
`v1.0.4` was tagged from the current `main` of
`https://github.com/wiswes/magento` and is what Adobe will resolve
to. Packagist publishes it as `wiswes/magento-mcp:1.0.4` within
...
you just enter `wiswes/magento-mcp` and version `1.0.4` in the
form.
...
portal. Fix them in the repo, push a new patch tag (`v1.0.4`),
